...
export default function SuccessPage() {
    ...
    const handleGoHome = () => {
        ...
        if (phone) {
            navigate('/dashboard'); // Connecté -> Dashboard
        } else {
            navigate('/'); // Pas connecté (bizarre mais possible) -> Accueil
        }
    };
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
            ...
            <p className="text-gray-500 mb-8 max-w-xs mx-auto">
                Votre commande est confirmée. Un livreur Wink Express a été notifié.
            </p>
            ...
            <div className="bg-gray-50 p-6 rounded-2xl w-full max-w-sm mb-8 border border-gray-100">
                ...
                <ul className="text-sm text-left space-y-4 text-gray-600">
                    <li className="flex gap-3">
                        ...
                        Le livreur vous appelle dans ~5 min.
                    </li>
                    <li className="flex gap-3">
            ...
            <WinkButton variant="action" onClick={handleGoHome}>
                <Home size={20} /> Retour à mon espace
            </WinkButton>
