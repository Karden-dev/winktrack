...
class SubscriberModel {
    ...
    // --- CORRECTION CRITIQUE POUR LE COMPTEUR ---
    static async incrementStats(id) {
        // On utilise COALESCE pour transformer NULL en 0 avant d'ajouter 1
        // Cela empêche le compteur de rester bloqué si la valeur initiale était vide
