...
exports.getDashboardInfo = async (req, res) => {
    try {
        ...
        // Calcul des stats Parrainage (Nouveau)
        const referralCount = await SubscriberModel.countReferrals(rider.referral_code);
        ...
        res.json({
            ...
            data: {
                ...
                photo: rider.photo_url, // Si dispo
                ...
                stats: {
                    ...
                    isExpired: isExpired,
                    referralCount: referralCount // <--- On envoie le nombre de filleuls
                },
                settings: {
